...
import {
    facialExpressions
} from '@/constants/avatar/avater-facial-expressions';
import {
    useAvatarStore
} from '@/store/avatar';
// import {
...
function Avatar({
    ...
    const applyMorphTargetToWolf3DNodes = (target, value, speed = 0.1) => {
        ...
        wolf3DNodes.forEach((node) => {
            if (node?.morphTargetDictionary && node?.morphTargetInfluences) {
                ...
                if (index !== undefined && node.morphTargetInfluences[index] !== undefined) {
    ...
    useEffect(() => {
        const isLipsyncActive = lipsyncData && lipsyncData.isActive && isAudioPlaying;
...
function resetMorphTargets() {
        ...
        traditionalTargets.forEach((target) => {
            const speed = target.includes('Smile') || target.includes('Squint')
...
useGLTF.preload('/models/animations/masculine/idle/F_Standing_Idle_Variations_002.glb');
useGLTF.preload('/models/animations/masculine/idle/F_Standing_Idle_Variations_003.glb');
useGLTF.preload('/models/animations/masculine/idle/M_Standing_Idle_Variations_007.glb');
useGLTF.preload('/models/animations/masculine/idle/M_Standing_Idle_Variations_005.glb');
useGLTF.preload('/models/animations/masculine/idle/M_Standing_Idle_002.glb');
useGLTF.preload('/models/animations/masculine/idle/M_Standing_Idle_Variations_010.glb');
useGLTF.preload('/models/animations/masculine/locomotion/M_Walk_001.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Talking_Variations_001.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Talking_Variations_002.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Talking_Variations_003.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Talking_Variations_007.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Talking_Variations_009.glb');
useGLTF.preload('/models/animations/masculine/expression/F_Talking_Variations_002.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Standing_Expressions_004.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Standing_Expressions_002.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Standing_Expressions_001.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Standing_Expressions_012.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Standing_Expressions_010.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Talking_Variations_005.glb');
useGLTF.preload('/models/animations/masculine/expression/M_Talking_Variations_006.glb');
useGLTF.preload('/models/animations/masculine/expression/F_Talking_Variations_002.glb');
useGLTF.preload('/models/animations/masculine/idle/F_Standing_Idle_Variations_001.glb');
