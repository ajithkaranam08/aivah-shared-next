...
import { MeshReflectorMaterial as MeshRef } from "@react-three/drei/materials/MeshReflectorMaterial";
...
export const Standard = memo(({ color }: { color: ColorRepresentation }) => {
  ...
  const materialRef = useRef<MeshRef>(null);
